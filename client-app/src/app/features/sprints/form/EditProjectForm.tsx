        ...
        <div >
            ...
            <Formik 
             ...
             <Form className='ui form' onSubmit={handleSubmit} autoComplete='off'>
                ...
                <InvisibleTextInput style={{cursor: 'pointer'}} fontsize={20} onClick={() => toggleProjectNameEditor(project_name_edit_state)}>
                   <h1 style={{paddingTop: "10px", paddingBottom: "10px", paddingLeft: "5px"}}> {selectedProject!.name} </h1>
                </InvisibleTextInput>
                }
                {project_name_edit_state &&
                <StyledInput 
                    ...
                    autoFocus 
                    onChange={(e: any) => setProjectNameState(e.target.value)}
                ...
                <InvisibleTextInput style={{marginTop: '4px', paddingTop: '0px', cursor: 'pointer', display: "flex", maxHeight: "700px", minHeight: "200px"}} fontsize={14} onClick={() => toggleDescriptionEditor(description_edit_state)}>
                    ...
                    <div style={{paddingTop: "8px", marginBottom: "20px", marginLeft: "12px", marginRight: "12px"}}> {parse(selectedProject!.description)} </div>
                ...
                }
                {
                    ...
                    <br/>
                    <Button size="mini" content="Save" color="blue" onClick={() =>{updateProjectDescription(); toggleDescriptionEditor(description_edit_state)} }/>
                ...
                {selectedProject!.assignees.map( (user, index) => (
                    <StyledLabel style={{marginBottom: "6px", marginRight: "4px"}} onClick={() => {console.log(user)} }>
