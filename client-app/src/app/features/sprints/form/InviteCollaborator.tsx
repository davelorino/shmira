...
export default observer(function InviteCollaboratorForm() {
    ...
    function invite(e: any, form: any, emailState: string){
        ...
        accountStore.invite(e, form, account_dto, invitation).catch(error => setError('Invalid email or password'));
        setInviteSent(true);
    }
        ...
        <div className='darkreader' style={{backgroundColor: 'transparent'}}>
            <form ref={form} onSubmit={(e) => handleSubmit(e)}>
                <div style={{width: '100%', minHeight: '200px',
                    ...
                    <div style={{paddingTop: '0px', marginTop: '20px', marginBottom: '20px', width: '100%', display: 'flex', flexWrap: 'wrap', justifyContent: 'center'}} >
                    <p>An email has been sent to the email address you provided with a link to join this project. If the person you have invited to work on the project is not registered with Shmira they will be sent a link to create an account.</p>
                    </div>
                </div>
            </form>
        </div>
        ...
        <div className='darkreader' style={{backgroundColor: 'transparent'}}>
            <form ref={form} onSubmit={(e) => handleSubmit(e)}>
                    <div style={{width: '100%', minHeight: '200px',
                        ...
                        <h2 style={{marginTop: '5px'}}>Invite a collaborator</h2>
                        <div style={{paddingTop: '0px', marginTop: '20px', marginBottom: '20px', width: '100%', display: 'flex', flexWrap: 'wrap', justifyContent: 'center'}} >
                        <p>If the person you are inviting doesn't have an account with Shmira they will be sent an invite to register an acccount, and will have access to this project upon registration.</p>
                        </div>
                        ...
                        <Button type='submit' content='Send invite' size='tiny' loading={loading}
