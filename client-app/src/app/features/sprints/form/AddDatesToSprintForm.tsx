        ...
        <div>
            <Formik 
             ...
             <Form className='ui form'  autoComplete='off'>
                ...
                <InvisibleTextInput fontsize={20} onClick={() => toggleSprintTitleEditState()}>
                   <h1 style={{paddingTop: "10px", paddingBottom: "10px", paddingLeft: "5px"}}> {selectedSprint!.name} </h1>
                </InvisibleTextInput>
                }
                {sprint_title_edit_state &&
                <StyledInput 
                    ...
                    onBlur={() => {updateSprintTitle(sprint_name); toggleSprintTitleEditState();}}
                />
                    
                }       

                {!sprint_description_edit_state && 
                <InvisibleTextInput style={{display: "flex", maxHeight: "700px", minHeight: "300px"}} fontsize={14} onClick={() => toggleSprintDescriptionEditState()}>
                    
                    <div style={{paddingTop: "20px", marginBottom: "20px", marginLeft: "12px", marginRight: "12px"}}> {parse(selectedSprint!.description)} </div>
                ...
                }
                {
                    sprint_description_edit_state &&
                    <>
                    <ReactQuill style={{minHeight: "300px", maxHeight: "700px"}} theme="snow" defaultValue={selectedSprint!.description} onChange={setSprintDescription}/>
                    
                    <br/>
                    <Button size="mini" content="Save" color="blue" onClick={() =>{updateSprintDescription(sprint_description); toggleSprintDescriptionEditState()} }/>
                    </>
                }     
                ...
                <Field style={{width: '18%'}} type='date' placeholder='' name='start_date' onChange={(e: any) => setSprintStartDate(e.target.value) } />
                
                
                <label style={{marginLeft: '25px'}}>End Date</label>
                <Field style={{width: '18%'}} type='date' placeholder='' name='end_date' onChange={(e: any) => setSprintEndDate(e.target.value) }  />
